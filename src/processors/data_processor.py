...
class VizNetDataProcessor(DataProcessor):
    def process(self, raw_data: str, layout_sequence: List[str], chart_image_sequence: List[str]) -> List[Dict]:
        ...
        # meta_data = {
        #     'pageTitle': raw_meta_data['pageTitle'],
        #     'title': raw_meta_data['title'],
        #     'url': raw_meta_data['url'],
        ...
        icon_selector = IconSelector(icon_pools[-1], topic_color=None, x_label=result['meta_data']['x_label'])
        ...
        if 'topic_icon' in layout_sequence:
            topic_icon_idx = 0
        if 'x_single_icon' in layout_sequence:
            x_single_icon_idx = topic_icon_idx + 1
        else:
            x_single_icon_idx = topic_icon_idx
        if 'x_multiple_icon' in layout_sequence:
        ...
        print("result['icons']['topic']: ", result['icons']['topic'])
        print("result['icons']['x_data_single']: ", result['icons']['x_data_single'])
        print("result['icons']['x_data_multi']: ", len(result['icons']['x_data_multi']))
