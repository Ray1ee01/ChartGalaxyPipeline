...
REQUIREMENTS_BEGIN
{
    "chart_type": "Horizontal Group Pictorial Bar Chart",
    "chart_name": "horizontal_group_pictorial_bar_chart_02",
    "is_composite": false,
        ...
        dimensions.forEach((dimension, dimIndex) => {
            ...
            if (dataPoint) {
                ...
                g.append("image")
                    ...
                    .attr("xlink:href", jsonData.images.field[dataPoint[groupField]])
