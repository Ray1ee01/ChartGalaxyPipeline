from modules.chart_engine.template.vegalite_py.line.step_line_chart import StepLineChart
...
REQUIREMENTS_BEGIN
{
    ...
    "chart_type": "Group Step Line Chart",
    "chart_name": "group_step_line_chart_base",
...
class GroupStepLineChart(StepLineChart):
