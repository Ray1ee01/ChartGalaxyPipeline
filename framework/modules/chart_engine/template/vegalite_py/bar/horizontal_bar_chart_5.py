from modules.chart_engine.template.vegalite_py.bar.horizontal_bar_chart_4 import HorizontalBarChart4
from typing import Dict
from modules.chart_engine.template.vegalite_py.components.color_encoding.color_encoding import available_first
...
class HorizontalBarChart5(HorizontalBarChart4):
    ...
    def make_color_specification(self, json_data: Dict) -> Dict:
        return available_first(json_data)
