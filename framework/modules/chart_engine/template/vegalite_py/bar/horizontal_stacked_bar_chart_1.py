from modules.chart_engine.template.vegalite_py.bar.horizontal_stacked_bar_chart_0 import HorizontalStackedBarChart0
...
class HorizontalStackedBarChart1(HorizontalStackedBarChart0):
