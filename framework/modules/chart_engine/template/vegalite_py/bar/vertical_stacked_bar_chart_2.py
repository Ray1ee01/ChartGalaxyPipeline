from modules.chart_engine.template.vegalite_py.bar.vertical_stacked_bar_chart_1 import VerticalStackedBarChart1
...
class VerticalStackedBarChart2(VerticalStackedBarChart1):
    ...
    def make_annotation_specification_2(self, json_data: Dict) -> Dict:
    ...
    def make_specification(self, json_data: Dict) -> Dict:
        ...
        new_annotation_spec = self.make_annotation_specification_2(json_data)
