from modules.chart_engine.template.vegalite_py.bar.horizontal_stacked_bar_chart_1 import HorizontalStackedBarChart1
...
class HorizontalStackedBarChart2(HorizontalStackedBarChart1):
    ...
    def make_axis_specification(self, json_data: Dict) -> Dict:
        ...
        y_encoding_spec['axis']['domainWidth'] = 5
        y_encoding_spec['axis']['domainColor'] = "#000000"
    ...
    def make_annotation_specification2(self, json_data: Dict) -> Dict:
    ...
    def make_specification(self, json_data: Dict) -> Dict:
        ...
        # 在specification中layer的每个里面的["encoding"]['y']都添加一个
        for layer in specification['layer']:
            layer['encoding']['y']['sort'] = sort_config
