from modules.chart_engine.template.vegalite_py.bar.horizontal_bar_chart_1 import HorizontalBarChart1
from typing import Dict
from modules.chart_engine.template.vegalite_py.components.color_encoding.color_encoding import x_gradient_primary_secondary
