from modules.chart_engine.template.vegalite_py.pie.pie_chart import PieChart
...
REQUIREMENTS_BEGIN
{
    ...
    "chart_type": "Group Pie Chart",
    "chart_name": "group_pie_chart_01",
